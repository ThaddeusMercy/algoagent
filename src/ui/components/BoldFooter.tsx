    ...
    return (
      <div
        className={SubframeUtils.twClassNames(
          "group/e35cb674 flex w-full flex-col items-center justify-center gap-6 border-t border-solid border-neutral-100 px-6 py-24",
          className
        )}
        ref={ref as any}
        {...otherProps}
      >
        <div className="flex w-full max-w-[1280px] flex-col items-center gap-12">
          <div className="flex w-full flex-wrap items-start gap-6">
            <div className="min-w-[144px] grow shrink-0 basis-0 flex-col items-start gap-6 hidden">
            ...
            <div className="min-w-[144px] grow shrink-0 basis-0 flex-col items-start gap-4 self-stretch hidden">
              <span className="w-full font-['Montserrat'] text-[14px] font-[600] leading-[20px] text-default-font -tracking-[0.01em]">
                Follow us
              </span>
          ...
          <div className="w-full flex-wrap items-start gap-6 hidden">
            ...
            <div className="min-w-[144px] grow shrink-0 basis-0 flex-col items-start gap-4 hidden">
            ...
            <div className="flex min-w-[144px] grow shrink-0 basis-0 flex-col items-start gap-4">
              ...
              <LinkButton className="hidden">Site Map</LinkButton>
            </div>
          </div>
